...
public class ContactsAdapter1 extends RecyclerView.Adapter<ContactsAdapter1.ContactsViewHolder> implements View.OnClickListener{

    private List<Contact> contacts;
    private OnItemClickListener mOnItemClickListener = null;
    private int layoutId;

    public ContactsAdapter1(List<Contact> contacts, int layoutId) {
    ...
    public void onBindViewHolder(ContactsViewHolder holder, int position) {
        ...
        holder.tv_name_one.setText(contact.getContent());
