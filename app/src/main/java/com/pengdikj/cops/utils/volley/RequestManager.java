...
import com.pengdikj.cops.fragment.LoadingFragment;
import com.pengdikj.cops.utils.LogUtil;
import com.pengdikj.cops.utils.PengDiApplication;

import java.io.UnsupportedEncodingException;

@SuppressLint("NewApi")
public class RequestManager {
    public static RequestQueue mRequestQueue = Volley.newRequestQueue(PengDiApplication
			.getApp());
