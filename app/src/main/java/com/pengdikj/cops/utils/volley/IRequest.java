...
public class IRequest {
	...
	public static void get(Context context, String url, RequestListener l) {
		RequestManager.get(NetConstant.URL+url, context, l);
	}
	...
	public static void get(Context context, String url, String progressTitle,
			RequestListener l) {
		RequestManager.get(NetConstant.URL+url, context, progressTitle, l);
	}
	...
	public static <T> void get(Context context, String url, Class<T> classOfT,
		...
		RequestManager.get(NetConstant.URL+url, context, classOfT, null, false, l);
	}
	...
	public static <T> void get(Context context, String url, Class<T> classOfT,
		...
		RequestManager.get(NetConstant.URL+url, context, classOfT, progressTitle, true, l);
	...
	public static <T> void get(Context context, String url, Class<T> classOfT,
		...
		RequestManager.get(NetConstant.URL+url, context, classOfT, progressTitle, LoadingShow,
				l);
	...
	public static void post(Context context, String url, RequestParams params,
			RequestListener l) {
		RequestManager.post(NetConstant.URL+url, context, params, l);
	}
	...
	public static <T> void post(Context context, String url, Class<T> classOfT,
		...
		RequestManager.post(NetConstant.URL+url, context, classOfT, params, null, false, l);
	}
	...
	public static void post(Context context, String url, RequestParams params,
		...
		RequestManager.post(NetConstant.URL+url, context, params, progressTitle, l);
	}
	...
	public static <T> void post(Context context, String url, Class<T> classOfT,
		...
		RequestManager.post(NetConstant.URL+url, context, classOfT, params, progressTitle,
				true, l);
	}
