...
import com.pengdikj.cops.navigation.Bean.StrategyBean;
...
public class CalculateRouteActivity extends BaseActivity implements AMapNaviListener, View.OnClickListener, AMap.OnMapLoadedListener {
    ...
    private AMap mAMap;
    private NaviLatLng endLatlng = new NaviLatLng(39.90759,119.392582);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView2Base(R.layout.activity_calculate_route);
        this.setTitle("线路规划");
        this.setToolBarLeftButtonByString(R.string.head_return);
        this.setBarColor(getResources().getColor(R.color.colorBlack));
    ...
    private void initNavi() {
        ...
        startLatlng = new NaviLatLng(DoNumberUtil.dblNullDowith(getIntent().getExtras().getString("startlat")),DoNumberUtil.dblNullDowith(getIntent().getExtras().getString("startlon")));
        endLatlng = new NaviLatLng(DoNumberUtil.dblNullDowith(getIntent().getExtras().getString("stoplat")),DoNumberUtil.dblNullDowith(getIntent().getExtras().getString("stoplon")));

        LogUtil.e("lat:",getIntent().getExtras().getString("stoplat"));
