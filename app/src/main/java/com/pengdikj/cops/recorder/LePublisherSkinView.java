            ...
            switch (i){
                case 0:
                    ...
                    if(data.get(0).status != 0){
                        v1.setBackgroundResource(R.mipmap.letv_recorder_angle_gray);
                ...
                case 1:
                    ...
                    if(data.get(1).status != 0){
                        v2.setBackgroundResource(R.mipmap.letv_recorder_angle_gray);
                ...
                case 2:
                    ...
                    if(data.get(2).status != 0){
                        v3.setBackgroundResource(R.mipmap.letv_recorder_angle_gray);
                ...
                case 3:
                    ...
                    if(data.get(3).status != 0){
                        v4.setBackgroundResource(R.mipmap.letv_recorder_angle_gray);
