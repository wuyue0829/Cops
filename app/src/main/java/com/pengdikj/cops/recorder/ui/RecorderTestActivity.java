        ...
        public void onClick(View v) {
            switch (v.getId()){
                case R.id.open://开始推流以及结束推流
                    ToastUtils.showShort(v.getContext(),"点击推流按钮");
                    cameraView.publish(path);
                    break;
                case R.id.change_flash://切换闪光灯
                    ToastUtils.showShort(v.getContext(),"点击闪光灯按钮");
                    cameraView.changeFlash();
                    break;
                case R.id.switch_filter: //切换滤镜效果
                    ToastUtils.showShort(v.getContext(),"点击滤镜按钮");
                    cameraView.switchFilter();
                    break;
                case R.id.switch_camera://切换前后置摄像头
                    ToastUtils.showShort(v.getContext(),"点击摄像头切换按钮");
                    cameraView.switchCamera();
                    break;
                case R.id.set_volume://切换声音
                    ToastUtils.showShort(v.getContext(),"点击声音按钮");
